  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '0',
      role: 'assistant',
      content: "So, you finally stopped making excuses and showed up. What's on your mind? Don't waste my time with lazy questions. Get to work. - Coach Tom",
      timestamp: new Date(),
    }
  ]);
        ...
        <div className="lg:col-span-4 space-y-8">
           <div className="relative group">
              ...
              <div className="relative bg-zinc-950 p-8 border border-zinc-900">
                ...
                <p className="text-zinc-500 font-bold uppercase tracking-widest text-sm mb-6">Direct Line to the Architect</p>
                <p className="text-zinc-400 text-sm leading-relaxed">
                  "I don't sugarcoat. I don't whisper. I give you the cold, hard truth of what it takes to reach the top. If you're sensitive, go somewhere else. If you want to build a tower, start talking."
                </p>
              </div>
           </div>
